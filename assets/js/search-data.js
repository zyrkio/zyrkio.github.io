...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Projects",
          description: "A collection of fun and innovative projects I&#39;ve worked on.",
          section: "Navigation",
          handler: () => {
          ...
          handler: () => {
            ...
            },{id: "post-website-launched",
        
          title: "Website Launched",
        
        description: "Exciting news! My personal website is now live.",
        section: "Posts",
        handler: () => {
          
            window.location.href = "/blog/2025/website-launched/";
          ...
          title: 'A simple inline announcement with Markdown emoji! :sparkles: :smile:',
          description: "",
          section: "News",},{id: "projects-deckdex-mtg-card-scanner",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-finance-app-stock-portfolio-tracker",
